    ...
    <section class="dash_content_app">
            ...
            <div class="dash_content_app_header_actions">
                <nav class="dash_content_app_breadcrumb">
                    <ul>
                        ...
                        <li class="separator icon-angle-right icon-notext"></li>
                        <li><a href="" class="text-orange">Cadastrar Modelo</a></li>
                    </ul>
                </nav>
        ...
        <div class="dash_content_app_box">
            ...
            <div class="nav">
                ...
                <form action="{{ route('admin.models.store') }}" method="post" class="app_form"
                        ...
                        <div id="data">
                            <div class="label_g2">
                                ...
                                <label class="label">
                                    ...
                                    <input type="text" name="name" placeholder="Nome da modelo"
                                        value="{{ old('name') ?? '' }}" />
                                </label>
