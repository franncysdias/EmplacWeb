    ...
    <div class="dash_login_left">
        <article class="dash_login_left_box">
            <header class="dash_login_box_headline">
                <div class="dash_login_box_headline_logo icon-notext"><img src="backend/assets/images/terra.png" width="300"></div>
            </header>
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.terrasoft.com.br">www.<b>terrasoft</b>.com.br</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=55+86+994107333&text=Olá, preciso de ajuda com o login."
